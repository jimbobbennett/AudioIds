...
//  AudioIds
//
//  Created by Jim Bennett on 28/06/2019.
//  Copyright © 2019 Jim Bennett. All rights reserved.
//
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        // insert code here...
        CFArrayRef ids = CreateInputDeviceArray();
        
        CFIndex nameCount = CFArrayGetCount( ids );
        
        //Iterate through the CFArrayRef and fill the vector
        for( int i = 0; i < nameCount ; ++i  )
        {
            CFStringRef sName = (CFStringRef)CFArrayGetValueAtIndex( ids, i );
            NSString *aNSString = (__bridge NSString *)sName;
